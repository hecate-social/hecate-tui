...
// Model is the Deployment & Operations phase view
type Model struct {
	width   int
	height  int
	focused bool
...
func (m Model) View() string {
	...
	b.WriteString(headerStyle.Render("🚀 Deployment & Operations"))
	b.WriteString("\n")
	b.WriteString(descStyle.Render("Ship and maintain in production"))
	b.WriteString("\n\n")
